			...
			<div class="col-md-3">
				<div class="category-sidebar">
								...
								if($temp = @mysqli_query($conn, "CALL SelectAllBrandProcedure()")){
									while($result = @mysqli_fetch_assoc($temp))
										if ($result != null) {
											...
											print '
												<li><a href="category.php?brand='.$brand.'">'.$brand.' <span>'.$count.'</span></a></li>
											';
										}
								}
							?>		
					...
					<div class="widget price-range w-100">
						<h4 class="widget-header">Material</h4>
						<input type="radio" name="itemName" value="All" id="All" style="cursor:pointer;" checked>
						<label for="All" class="py-2" style="cursor:pointer;">All</label>
						<br>
						<input type="radio" name="itemName" value="Aluminum" id="Aluminum" style="cursor:pointer;" <?php echo (isset($_GET['tr']) && $_GET['tr']=='Aluminum')? 'checked' : ''; ?>>
						<label for="Aluminum" class="py-2" style="cursor:pointer;">Aluminum</label>
						<br>	
						<input type="radio" name="itemName" value="Fiber" id="Fiber" style="cursor:pointer;" <?php echo (isset($_GET['tr']) && $_GET['tr']=='Fiber')? 'checked' : ''; ?>>
						<label for="Fiber" class="py-2" style="cursor:pointer;">bikebon Fiber</label>
						<br>
						<input type="radio" name="itemName" value="Steel" id="Steel" style="cursor:pointer;" <?php echo (isset($_GET['tr']) && $_GET['tr']=='Steel')? 'checked' : ''; ?>>
						<label for="Steel" class="py-2" style="cursor:pointer;">Steel</label>
						<br>
						<input type="radio" name="itemName" value="Titanium" id="Titanium" style="cursor:pointer;" <?php echo (isset($_GET['tr']) && $_GET['tr']=='Titanium')? 'checked' : ''; ?>>
